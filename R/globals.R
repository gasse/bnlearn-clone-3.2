...
local.search.algorithms = c("mmpc", "si.hiton.pc", "gs.pc", "iapc", "fast.iapc", "inter.iapc", "fdr.iapc", "hpc", "cached.hpc", "pc", "rpc")
...
method.labels = c(
  ...
  'rpc' = "Reversed Parents and Children",
  ...
  'fdr.iapc' = "Incremental Association with False Discovery Rate control + neighbourhood filtering",
